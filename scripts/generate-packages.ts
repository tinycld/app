...
async function main() {
    ...
    // Seeds are no longer generated — the seed runner derives them (in
    // dependency order) at runtime from tinycld.config.ts via deriveSeeds
    // (core/lib/packages/derive-seeds.ts).
